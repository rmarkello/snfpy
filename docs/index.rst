...
(2014).
`Similarity Network Fusion: a fast and effective method to aggregate multiple data types on a genome wide scale. <http://dx.doi.org/10.1038/nmeth.2810>`_
*Nature Methods*, *11*, 333-7.
